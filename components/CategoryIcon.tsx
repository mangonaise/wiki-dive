...
const MathematicsIcon = () => { return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"><rect x="13.12" y="22.32" width="23.23" height="5.36" rx="1.48" fill="currentColor" /><circle cx="24.73" cy="16.14" r="3.15" fill="currentColor" /><circle cx="24.73" cy="33.86" r="3.15" fill="currentColor" /></svg> }
